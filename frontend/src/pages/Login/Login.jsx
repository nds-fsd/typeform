      ...
      <div className='bg-white p-16 rounded-3xl shadow-md w-full max-w-md flex flex-col items-center'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6 w-full flex flex-col items-center'>
          <div className='w-full'>
            ...
            />
            {error.email && (
              <p id='email_error' className='text-red-600 text-sm font-space mono'>
                {error.email}
              </p>
            )}
          </div>
          <div className='w-full'>
            ...
            />
            {error.password && (
              <p id='password_error' className='text-red-600 text-sm font-space mono'>
                {error.password}
              </p>
            )}
          </div>
          ...
          <a
            className='flex flex-row text-blue-600 hover:text-blue-800 text-sm font-space mono cursor-pointer'
            onClick={() => {
              navigate('/signup');
            }}
          >

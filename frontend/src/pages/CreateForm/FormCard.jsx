...
const FormCard = ({ form }) => {
  ...
  return (
    <div
      className='relative w-60 h-40 flex flex-col items-center justify-center shadow-md rounded-3xl bg-azure/80 hover:shadow-none transition-all duration-75 font-space-mono  hover:bg-gray-200/30'
